...
gcc  -g -fsanitize=address -Wp,-MMD,scripts/kconfig/.bridge.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89      -D_DEFAULT_SOURCE -D_XOPEN_SOURCE=600 -c -o scripts/kconfig/bridge.o scripts/kconfig/bridge.c
